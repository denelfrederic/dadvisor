...
export const ALTERNATIVE_PINECONE_URL = `https://${PINECONE_INDEX}-3q5v9g1.svc.${PINECONE_ENVIRONMENT}.pinecone.io`;

// Validation de la configuration
export const validateConfig = () => {
  console.log(`Pinecone Edge Function initialisée. URL: ${PINECONE_BASE_URL}`);
  console.log(`URL alternative configurée: ${ALTERNATIVE_PINECONE_URL}`);
