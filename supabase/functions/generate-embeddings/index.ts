...
const EMBEDDING_MODEL = 'sentence-transformers/paraphrase-multilingual-MiniLM-L12-v2'; // Modèle multilingue
...
serve(async (req) => {
  ...
  try {
    ...
    // Appel à l'API Hugging Face pour générer l'embedding
