    ...
    <section id="features-section" className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <SectionHeader 
          ...
          title="Comprenez qui vous êtes en tant qu'investisseur"
          description="DADVISOR vous guide à travers un parcours simple et éducatif pour déterminer votre profil d'investissement personnel, sans jamais toucher à vos fonds."
        />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
          <FeatureCard 
            ...
            title="Profilage Personnalisé"
            description="Notre questionnaire évalue votre tolérance au risque et vos connaissances financières pour vous aider à mieux comprendre votre profil d'investisseur."
          />
          ...
          <FeatureCard 
            ...
            title="Portefeuilles Multi-Actifs"
            description="Accédez à des portefeuilles diversifiés intégrant cryptomonnaies et actifs traditionnels (RWA), adaptés à votre profil d'investisseur."
          />
          ...
          <FeatureCard 
            ...
            title="Contrôle Total de vos Fonds"
            description="DADVISOR ne gère jamais vos flux financiers. Avec l'autoconservation, vous gardez 100% du contrôle de vos investissements à tout moment."
          />
        </div>
      </div>
    </section>
